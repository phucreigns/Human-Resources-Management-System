package com.phuc.auth.exception;
...
public enum ErrorCode {
    ...
    CODE_IS_EMPTY(1011, "The code is empty. Please try again later.", HttpStatus.BAD_REQUEST),
    CODE_EXPIRED_OR_INVALID(1012, "Authorization code expired or invalid. Please try logging in again.", HttpStatus.BAD_REQUEST),
